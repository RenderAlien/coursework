...
<template>
  <div class="content-text">Добрый день!</div>
  ...
  <div class="container">
    <div class="row justify-content-center row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-1 row-cols-1">
      <div v-for="item in store.lastn(4)" class="d-flex justify-content-center mb-4">
        <!--Карточка документа-->
  ...
  <div class="container">
    <div class="row justify-content-center row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-1 row-cols-1">
      <div v-for="item in store.dep_lastn(store.my_department, 4)" class="d-flex justify-content-center mb-4">
        <!--Карточка документа-->
        <div class="card h-100" style="width: 290px;">
          <img :src="store.image(item)" class="card-img-top card-image" alt="...">
          <div class="card-body">
